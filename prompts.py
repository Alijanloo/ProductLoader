...
2. short_description: Provide 5-10 most important attributes of the product that grasps user attention in a bullet-point markdown format. does'n need introduction, just list the attributes concisely by keywords. like:
* روشن کنندگی زیاد
* رفع گودی چشم
* رفع چین و چروک صورت
...
